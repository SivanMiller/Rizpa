...
//            }
    ...
    public void addFunds(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void reportTransactions(HttpServletRequest request, HttpServletResponse response) throws IOException {
        try (PrintWriter out = response.getWriter()) {
            response.setContentType("application/json");
